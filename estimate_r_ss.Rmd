...
dfs <- list(
  ...
  yao = rio::import("data/2016_Yao_BRM.csv"),
  ...
  lima = rio::import("data/2021_de Lima_SAGEOpen.csv"),
  liu = rio::import("data/2021_Liu_FrontPsychol.csv"),
  petit = rio::import("data/2021_Peti-Stantic_BRM.xlsx"),
  ballot = rio::import("data/2022_Ballot_BRM.xlsx"),
  sarli = rio::import("data/2022_Sarli_BRM.xlsx"),
  raslescu = rio::import("data/2023_Raslescu_DIB.xlsx"),
  su = rio::import("data/2023_Su_BRM_2.xlsx"),
  chan = rio::import("data/2024_Chan_BRM.xlsx"),
  conca = rio::import("data/2024_Conca_BRM.xlsx"),
  falcinelli = rio::import("data/2024_Falcinellli_Collabra.xlsx"),
  mahjou = rio::import("data/2024_Mahjoubnavaz_JPsycholinguistRes.xlsx"),
  borsa = rio::import("data/2025_Borsa_BrainSci.xlsx"),
  kraljevic = rio::import("data/2018_Kraljevic_Suvremena.csv")
...
for (lang in languages) {
  ...
  lang_map <- list(
    ...
    "turkish" = "russian-gsd-ud-2.5-191206.udpipe"
  )
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["eilola"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["yao"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["mikla"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["scott"]],
                        item_col = "word_english",
                        mean_col = "familiar_mean",
                        sd_col = "familiar_sd",
                        n_per_item = 22,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["verheyen"]],
                        item_col = "word_dutch",
                        mean_col = "familiar_mean",
                        sd_col = "familiar_sd",
                        n_per_item = 13,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["lima"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["liu"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["petit"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["ballot"]],
                        item_col = "word_french",
                        mean_col = "freq_subjective_mean_all",
                        sd_col = "freq_subjective_sd_all",
                        n_per_item = 137,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["sarli"]],
                        item_col = "word_spanish",
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["raslescu"]],
                        item_col = "word_english",
                        mean_col = "freq_mean",
                        sd_col = "freq_sd",
                        n_per_item = 198,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["su"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["chan"]],
                        item_col = "word_chinese-gsd",
                        mean_col = "familiar_mean",
                        sd_col = "familiar_sd",
                        n_per_item = 20,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["conca"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["falcinelli"]],
                        item_col = "word_italian",
                        mean_col = "familiar_mean",
                        sd_col = "familiar_sd",
                        n_per_item = 20,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["mahjou"]],
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["borsa"]],
                        item_col = "word_italian",
                        mean_col = "familiar_mean",
                        sd_col = "familiar_sd",
                        n_per_item = 20,
...
```{r eval = F}
saved_sim <- run_simulation_pipeline(df = dfs[["kraljevic"]],
                        item_col = "word_croatian",
                        mean_col = "familiar_mean",
                        sd_col = "familiar_sd",
                        n_per_item = 33,
